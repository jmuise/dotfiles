...
The merge and force-push blocks, and the AI-attribution block, live in the user tier as `PreToolUse` hooks plus a `permissions.deny` rule. Project config must never weaken them.
